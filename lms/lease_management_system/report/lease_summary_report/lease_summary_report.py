...
def execute(filters=None):
	...
	columns=[
		...
		{"label": "Opening ROU Asset", "fieldname": "rou_opening", "fieldtype": "Currency", "width": 200,"precision": 2,},
		{"label": "Closing ROU Asset", "fieldname": "rou_closing", "fieldtype": "Currency", "width": 200,"precision": 2,},
		{"label": "Opening Liability", "fieldname": "liability_opening", "fieldtype": "Currency", "width": 200,"precision": 2,},
		{"label": "Closing Liability", "fieldname": "liability_closing", "fieldtype": "Currency", "width": 200,"precision": 2,},
		{"label": "Rent Paid", "fieldname": "rent_paid", "fieldtype": "Currency", "width": 200,"precision": 2,},
		{"label": "Interest Expense", "fieldname": "interest", "fieldtype": "Currency", "width": 200,"precision": 2,},
		{"label": "Depreciation", "fieldname": "depreciation", "fieldtype": "Currency", "width": 200,"precision": 2,},
		{"label": "Additions - ROU Asset", "fieldname": "additions_rou_asset", "fieldtype": "Currency", "width": 120,"precision": 2,},
		{"label": "Additions - Lease Liability", "fieldname": "additions_lease_liability", "fieldtype": "Currency", "width": 120,"precision": 2,},
		{"label": "Check ROU", "fieldname": "check_rou", "fieldtype": "Currency", "width": 200,"precision": 2,},
		{"label": "Check Lease Liability", "fieldname": "check_liability", "fieldtype": "Currency", "width": 200,"precision": 2,},
	]
	...
	# 	# If month is Jan–Mar, the financial year started last year
	# 	if d.month < 4:
	# 		start_year = year - 1
	# 		end_year = year
	# 	else:
	...
	leases = frappe.get_all("Lease Management", order_by="name asc", filters={"Company": company_name,}, fields=["name"])
	...
	for lease in leases:
		...
		liability_check=opening_liability+total_interest_cost-total_rent_paid-closing_liability+additions_rou_asset
