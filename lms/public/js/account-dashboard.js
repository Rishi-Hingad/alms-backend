...
// 		$(".total-expired-lease-agreement,.total-ongoing-lease-agreement").each(function () {
...
// 		var frappRoute = frappe.get_route_str
// 			? frappe.get_route_str()
// 			: "frappe.get_route_str not available";
// 		var frappRouteArray = frappe.get_route
// 			? frappe.get_route()
// 			: "frappe.get_route not available";
...
// 		if (
// 			route &&
// 			(route.includes("account-dashboard") || route.includes("account_dashboard"))
// 		) {
...
// 		if (
// 			frappRoute &&
// 			(frappRoute.includes("account-dashboard") || frappRoute.includes("account_dashboard"))
// 		) {
// 			isAccountDashboard = true;
// 		}
...
// 			window.location.href.includes("account_dashboard")
// 		) {
// 			isAccountDashboard = true;
// 		}
