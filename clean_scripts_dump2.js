...
async function openQuotationDialog(frm) {
    ...
    let html = data.map(q => `
        ...
        <div style="margin:10px;">
            ...
            <button class="btn btn-success btn-sm approve" data-id="${q.name}">l%,%%b%</button>

            <button class="btn btn-danger btn-sm reject" data-id="${q.name}">l%,%%W%</button>
