...
def _render_email_template(template_name, context):
    ...
    try:
        ...
        if template_doc.response_html:
            raw_message = template_doc.response_html
        else:
            raw_message = template_doc.response
        ...
        rendered_message = frappe.render_template(raw_message, context) if raw_message else ""
