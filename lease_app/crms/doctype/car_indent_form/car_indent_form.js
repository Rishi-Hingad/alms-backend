function renderPurchaseRedirectButton(frm) {
    ...
    if (
        ...
        frappe.call({
            method: "lease_app.crms.doctype.car_indent_form.car_indent_form.check_purchase_form_exists",
            args: {
        ...
        if (frappe.session.user === "Administrator" && !frm.is_new()) {
            frm.add_custom_button(__('Force Delete'), function () {
                frappe.confirm(
                    ...
                    function () {
                        frappe.call({
                            method: "lease_app.crms.doctype.car_indent_form.car_indent_form.force_delete",
                            args: {
