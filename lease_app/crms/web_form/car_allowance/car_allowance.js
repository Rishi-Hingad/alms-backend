...
frappe.ready(function () {
    ...
    if (employeeCode) {
        ...
        frappe.call({
            method: "lease_app.crms.web_form.car_allowance.car_allowance.get_employee_details",
    ...
    frappe.web_form.validate = function () {
        ...
        frappe.call({
            method: "lease_app.crms.web_form.car_allowance.car_allowance.check_allowance_exists",
            args: { employee_code: employeeCode },
            async: false,
            callback: function (r) {
                if (r.message === "exists") {
    ...
    frappe.web_form.after_save = function () {
        const employeeCode = frappe.web_form.get_value("employee_code");
        frappe.call({
            method: "lease_app.crms.web_form.car_allowance.car_allowance.send_allowance_email",
            args: { employee_code: employeeCode },
            callback: function () {
                frappe.show_alert({
