...
frappe.ready(function () {
    ...
    if (employeeCode) {
        ...
        frappe.call({
            method: "lease_app.crms.web_form.car_indent_form_employee.car_indent_form_employee.get_employee_details",
            args: {
    ...
    frappe.web_form.validate = function () {
        ...
        if (formType === "Allowance") {
            return new Promise((resolve, reject) => {
                frappe.call({
                    method: "lease_app.crms.web_form.car_indent_form.car_indent_form.send_allowance_email",
        ...
        if (formType === "Car") {
            return new Promise((resolve, reject) => {
                frappe.call({
                    method: "lease_app.crms.web_form.car_indent_form_employee.car_indent_form_employee.check_indent_exists",
                    args: { employee_code: employeeCode },
                    callback: function (response) {
